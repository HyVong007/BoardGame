...
namespace BoardGames
{
	...
	public sealed class Button : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
	{
		...
		private readonly List<Func<Vector2, bool>> list_beginDrag = new List<Func<Vector2, bool>>(),
			list_dragging = new List<Func<Vector2, bool>>();
		...
		[SerializeField]
		[ShowIf("show_interactable")]
		private Color activeColor = Color.white, disabledColor = new Color(1, 1, 1, 0.5f);
