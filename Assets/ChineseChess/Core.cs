...
namespace BoardGames.ChineseChess
{
	...
	public sealed class Core
	{
		...
		{
			[Color.Red] = new Rect(0, 0, 8, 4),
			[Color.Black] = new Rect(0, 5, 8, 9)
		}, PALACES = new Dictionary<Color, Rect>
		{
			[Color.Red] = new Rect(3, 0, 5, 2),
			[Color.Black] = new Rect(3, 7, 5, 9)
		};
		...
		public sealed class MoveData : IMoveData
		{
			...
			[DataMember] public readonly Piece piece;
			[DataMember] public readonly Vector2Int from, to;
